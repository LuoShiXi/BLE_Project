 ...
 */
public class AssistantLocation extends CheckPermissionsActivity implements OnClickListener {
	...
	private void initWebView(){
		...
		webView.setWebChromeClient(new WebChromeClient() {
			...
			public void onProgressChanged(WebView view, int newProgress) {
				AssistantLocation.this.getWindow().setFeatureInt(
